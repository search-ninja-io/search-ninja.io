...
export class SearchIndexServiceApi {
    ...
    public createMethodOptions(authorizationType: AuthorizationType): MethodOptions {
        return {
    ...
    public createCorsOptions(statusCode: number, allowOrigins: string): CorsOptions {
        return {
    ...
    public addMethod(
        ...
        httpMethods.forEach((httpMethod) =>
            resource.addMethod(httpMethod.method, lambdaIntegration, httpMethod.options),
        );
